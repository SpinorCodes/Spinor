...
x_min = -4.0 + 0.5*ds;                                         // Setting "x_min"...
x_max = +4.0 + 0.5*ds;                                         // Setting "x_max"...
y_min = -0.1;                                                  // Setting "y_min"...
y_max = +0.1;                                                  // Setting "y_max"...
z_min = -0.1;                                                  // Setting "z_min"...
z_max = +0.1;                                                  // Setting "z_max"...
...
Transfinite Curve {AB} = (x_max - x_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {EF} = (x_max - x_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {CD} = (x_max - x_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {GH} = (x_max - x_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {BC} = (y_max - y_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {DA} = (y_max - y_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {FG} = (y_max - y_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {HE} = (y_max - y_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {EA} = (z_max - z_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {FB} = (z_max - z_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {CG} = (z_max - z_min)/ds + 1;                // Applying transfinite algorithm...
Transfinite Curve {DH} = (z_max - z_min)/ds + 1;                // Applying transfinite algorithm...
