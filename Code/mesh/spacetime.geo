...
x_min = -8.0 - 0.5*dx;                                         // Setting "x_min"...
x_max = +8.0 + 0.5*dx;                                         // Setting "x_max"...
y_min = -8.0 - 0.5*dy;                                                  // Setting "y_min"...
y_max = +8.0 + 0.5*dy;                                                  // Setting "y_max"...
z_min = -dz;                                                  // Setting "z_min"...
z_max = +dz;                                                  // Setting "z_max"...
