...
int main ()
{
  ...
  dt_CFL          = sqrt (dm/k);                                                                    // Computing Courant-Friedrichs-Lewy critical time step [s]...
  dt_simulation   = 0.2f*dt_CFL;                                                                    // Setting simulation time step [s]...
  ...
  std::cout << "Courant-Friedrichs-Lewy critical time step = " << dt_CFL << " [s]" << std::endl;    // Printing message...
