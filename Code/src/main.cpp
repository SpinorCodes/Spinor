...
int main ()
{
  ...
  std::cout << "point nodes = " << point_nodes << std::endl;
  ...
  spinor->process (EFGH, 2, NU_MSH_PNT);                                                            // Processing mesh...
  point       = spinor->node;                                                                       // Getting nodes on border...
  point_nodes = point.size ();                                                                      // Getting the number of nodes on border...
  std::cout << "point nodes = " << point_nodes << std::endl;
  ...
  spinor->process (ADHE, 2, NU_MSH_PNT);                                                            // Processing mesh...
  point       = spinor->node;                                                                       // Getting nodes on border...
  point_nodes = point.size ();                                                                      // Getting the number of nodes on border...
  std::cout << "point nodes = " << point_nodes << std::endl;
  ...
  spinor->process (BCGF, 2, NU_MSH_PNT);                                                            // Processing mesh...
  point       = spinor->node;                                                                       // Getting nodes on border...
  point_nodes = point.size ();                                                                      // Getting the number of nodes on border...
  std::cout << "point nodes = " << point_nodes << std::endl;
  ...
  spinor->process (ABFE, 2, NU_MSH_PNT);                                                            // Processing mesh...
  point       = spinor->node;                                                                       // Getting nodes on border...
  point_nodes = point.size ();                                                                      // Getting the number of nodes on border...
  std::cout << "point nodes = " << point_nodes << std::endl;
  ...
  spinor->process (DCGH, 2, NU_MSH_PNT);                                                            // Processing mesh...
  point       = spinor->node;                                                                       // Getting nodes on border...
  point_nodes = point.size ();                                                                      // Getting the number of nodes on border...
  std::cout << "point nodes = " << point_nodes << std::endl;
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    cl->write (16);                                                                                 // Writing particle position...
