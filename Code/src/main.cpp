...
#define SPINOR_SCALE   0.999f                                                                        // Spinor scale factor.
...
float                            E              = 1.0E+3f;                                           // Young's modulus [Pa];
float                            ni             = 0.0f;                                              // Poisson's ratio [];
float                            beta           = 1.0E+0f;                                           // Damping [kg*s*m].
...
int main ()
{
  ...
  while(!gl->closed ())                                                                              // Opening window...
  {
    ...
    ImGui::PopStyleColor ();                                                                         // Restoring text color...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::Text ("Y = ");                                                                            // Writing text...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::InputFloat (" [Pa]", &E, 0.0f, 0.0f, "%e");                                               // Adding input field...

    ImGui::PushStyleColor (ImGuiCol_Text, IM_COL32 (0,255,0,255));                                   // Setting text color...
    ImGui::Text ("Poisson's ratio:  ");                                                              // Writing text...
    ImGui::PopStyleColor ();                                                                         // Restoring text color...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::Text ("nu = ");                                                                           // Writing text...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::InputFloat (" []", &ni, 0.0f, 0.0f, "%e");                                                // Adding input field...

    ImGui::PushStyleColor (ImGuiCol_Text, IM_COL32 (0,255,0,255));                                   // Setting text color...
    ImGui::Text ("Damping:        ");                                                                // Writing text...
    ImGui::PopStyleColor ();                                                                         // Restoring text color...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::Text ("beta = ");                                                                         // Writing text...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::InputFloat (" [kg*s*m]", &beta, 0.0f, 0.0f, "%e");                                        // Adding input field...

    ImGui::PushStyleColor (ImGuiCol_Text, IM_COL32 (0,255,0,255));                                   // Setting text color...
    ImGui::Text ("Particle's radius: ");                                                             // Writing text...
    ImGui::PopStyleColor ();                                                                         // Restoring text color...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::Text ("R = ");                                                                            // Writing text...
    ImGui::SameLine ();                                                                              // Staying on same line...
    ImGui::InputInt (" [#cells]", &R);                                                               // Adding input field...
